...
const Content=(props)=> {
	return (
		<div>
			...
			<Section title="Objetivos">
				...
				<ol>
					<li>Comparar o código fonte de sites mais antigos com o de sites novos para encontrar as principais diferenças entre eles.</li>
					...
					<li>Utilizar alguma ferramenta que permita visualizar como os sites eram antigamente, como o Wayback Machine, e comparar o código fonte/layout das versões antigas com o da versão atual.</li>
					...
					<li>Utilizar o portal para que as empresas interessadas possam melhorar seus sites e saber o que é ideal para seus usuários. Uma avaliação um pouco baixa não significa que a empresa não se preocupa com o tema, mas alguns pontos podem passar despercebidos durante o desenvolvimento.</li>
 ...
 <p>De acordo com a MWPT (2022), isso se deve principalmente ao crescimento de sites ativos, sobretudo os pequenos, nos quais a preocupação com a acessibilidade pode ser menor. O CEO da BigDataCorp, Thoran Rodrigues (Big Data Corp, 2022), afirma que, conforme aumenta a complexidade dos sites e da navegação, a tendência de testes falharem fica cada vez maior.</p>
			...
			<Section title="Metodologia">
				<p>As empresas que receberem boas notas ou estiverem evoluindo receberão um selo oficialmente dado pelo Accessibling, chamado selo de valorização ao usuário. Ele mostra que a empresa se preocupa com o tema da acessibilidade digital e busca atender a todos os clientes, independente de qualquer deficiência.</p>
			</Section>
